...
SCALE_FACTOR = 1 #Reducing to_theta so that bounds are respected
...
hist(y_samples$numpy(), freq=FALSE,100)
library(car)
qqplot(dat.s[,2], as.numeric(y_samples$numpy()))
summary(dat.s[,2])
